 ...
 * only indirectly through ecr/arch.h
 */
...
#ifndef __ASSEMBLY__
#  include <stdint.h>
#  include <ecr/pgalloc.h>
#  include <ecr/addrenv.h>
#endif
 ...
 * that is defined in the header file ecr/include/ecr/sched.h. The type
 * group_addrenv_t must be defined by platform specific logic in
 * ecr/arch/<architecture>/include/arch.h.
 *

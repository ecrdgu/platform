...
#    ifndef CONFIG_STM32F0_DMA1
#      error STM32F0 USART2/3 receive DMA requires CONFIG_STM32F0_DMA1
#    endif
#  endif
 ...
 *
 * See stm32f0serial_restoreusartint where the masking is done.
 */

#ifdef CONFIG_STM32F0_SERIALBRK_BSDCOMPAT
...
static void stm32f0serial_setformat(FAR struct uart_dev_s *dev);
#endif
static int  stm32f0serial_setup(FAR struct uart_dev_s *dev);
static void stm32f0serial_shutdown(FAR struct uart_dev_s *dev);
static int  stm32f0serial_attach(FAR struct uart_dev_s *dev);
static void stm32f0serial_detach(FAR struct uart_dev_s *dev);
static int  up_interrupt(int irq, FAR void *context, FAR void *arg);
static int  stm32f0serial_ioctl(FAR struct file *filep, int cmd,
                                unsigned long arg);
#ifndef SERIAL_HAVE_ONLY_DMA
static int  stm32f0serial_receive(FAR struct uart_dev_s *dev,
                                  FAR unsigned int *status);
static void stm32f0serial_rxint(FAR struct uart_dev_s *dev, bool enable);
static bool stm32f0serial_rxavailable(FAR struct uart_dev_s *dev);
#endif
#ifdef CONFIG_SERIAL_IFLOWCONTROL
static bool stm32f0serial_rxflowcontrol(FAR struct uart_dev_s *dev,
                                        unsigned int nbuffered, bool upper);
#endif
static void stm32f0serial_send(FAR struct uart_dev_s *dev, int ch);
static void stm32f0serial_txint(FAR struct uart_dev_s *dev, bool enable);
static bool stm32f0serial_txready(FAR struct uart_dev_s *dev);

#ifdef SERIAL_HAVE_DMA
static int  stm32f0serial_dmasetup(FAR struct uart_dev_s *dev);
static void stm32f0serial_dmashutdown(FAR struct uart_dev_s *dev);
static int  stm32f0serial_dmareceive(FAR struct uart_dev_s *dev,
                                     FAR unsigned int *status);
static void stm32f0serial_dmarxint(FAR struct uart_dev_s *dev, bool enable);
static bool stm32f0serial_dmarxavailable(struct uart_dev_s *dev);

static void stm32f0serial_dmarxcallback(DMA_HANDLE handle, uint8_t status,
                                        FAR void *arg);
#endif

#ifdef CONFIG_PM
static void stm32f0serial_pmnotify(FAR struct pm_callback_s *cb, int domain,
                                   enum pm_state_e pmstate);
static int  stm32f0serial_pmprepare(FAR struct pm_callback_s *cb, int domain,
                                    enum pm_state_e pmstate);
#endif
...
{
  .setup          = stm32f0serial_setup,
  .shutdown       = stm32f0serial_shutdown,
  .attach         = stm32f0serial_attach,
  .detach         = stm32f0serial_detach,
  .ioctl          = stm32f0serial_ioctl,
  .receive        = stm32f0serial_receive,
  .rxint          = stm32f0serial_rxint,
  .rxavailable    = stm32f0serial_rxavailable,
#ifdef CONFIG_SERIAL_IFLOWCONTROL
  .rxflowcontrol  = stm32f0serial_rxflowcontrol,
#endif
  .send           = stm32f0serial_send,
  .txint          = stm32f0serial_txint,
  .txready        = stm32f0serial_txready,
  .txempty        = stm32f0serial_txready,
};
#endif
...
{
  .setup          = stm32f0serial_dmasetup,
  .shutdown       = stm32f0serial_dmashutdown,
  .attach         = stm32f0serial_attach,
  .detach         = stm32f0serial_detach,
  .ioctl          = stm32f0serial_ioctl,
  .receive        = stm32f0serial_dmareceive,
  .rxint          = stm32f0serial_dmarxint,
  .rxavailable    = stm32f0serial_dmarxavailable,
#ifdef CONFIG_SERIAL_IFLOWCONTROL
  .rxflowcontrol  = stm32f0serial_rxflowcontrol,
#endif
  .send           = stm32f0serial_send,
...
#ifdef CONFIG_STM32F0_USART1
static struct stm32f0_serial_s g_usart1priv =
{
  .dev =
    {
#if CONSOLE_USART == 1
...
#ifdef CONFIG_STM32F0_USART2
static struct stm32f0_serial_s g_usart2priv =
{
  .dev =
    {
#if CONSOLE_USART == 2
...
#ifdef CONFIG_STM32F0_USART3
static struct stm32f0_serial_s g_usart3priv =
{
  .dev =
    {
#if CONSOLE_USART == 3
...
{
  .notify  = stm32f0serial_pmnotify,
  .prepare = stm32f0serial_pmprepare,
};
#endif
...
/****************************************************************************
 * Name: stm32f0serial_getreg
 ****************************************************************************/

static inline uint32_t stm32f0serial_getreg(FAR struct stm32f0_serial_s *priv,
                                            int offset)
{
...
/****************************************************************************
 * Name: stm32f0serial_putreg
 ****************************************************************************/

static inline void stm32f0serial_putreg(FAR struct stm32f0_serial_s *priv,
                                          ...
                                          uint16_t ie)
{
  ...
  cr = stm32f0serial_getreg(priv, STM32F0_USART_CR1_OFFSET);
  cr &= ~(USART_CR1_USED_INTS);
  cr |= (ie & (USART_CR1_USED_INTS));
  stm32f0serial_putreg(priv, STM32F0_USART_CR1_OFFSET, cr);

  cr = stm32f0serial_getreg(priv, STM32F0_USART_CR3_OFFSET);
  cr &= ~USART_CR3_EIE;
  cr |= (ie & USART_CR3_EIE);
  ...
  if (ie)
    {
      ...
      cr1 = stm32f0serial_getreg(priv, STM32F0_USART_CR1_OFFSET);
      cr3 = stm32f0serial_getreg(priv, STM32F0_USART_CR3_OFFSET);
...
#ifdef SERIAL_HAVE_DMA
static int stm32f0serial_dmanextrx(FAR struct stm32f0_serial_s *priv)
{
  size_t dmaresidual;

  dmaresidual = stm32f0_dmaresidual(priv->rxdma);
...
static void stm32f0serial_setformat(FAR struct uart_dev_s *dev)
{
  ...
  if (usartdiv8 > 100)
   ...
   stm32f0serial_putreg(priv, STM32F0_USART_CR1_OFFSET, cr1);
   stm32f0serial_putreg(priv, STM32F0_USART_BRR_OFFSET, brr);
  ...
  stm32f0serial_putreg(priv, STM32F0_USART_CR1_OFFSET, regval);

  /* Configure STOP bits */

  regval = stm32f0serial_getreg(priv, STM32F0_USART_CR2_OFFSET);
  ...
  stm32f0serial_putreg(priv, STM32F0_USART_CR2_OFFSET, regval);
...
#if defined(CONFIG_SERIAL_IFLOWCONTROL) && !defined(CONFIG_STM32F0_FLOWCONTROL_BROKEN)
  ...
  stm32f0serial_putreg(priv, STM32F0_USART_CR3_OFFSET, regval);
}
#endif /* CONFIG_SUPPRESS_UART_CONFIG */

/****************************************************************************
 * Name: stm32f0serial_setapbclock
 *
 * Description:
...
static void stm32f0serial_setapbclock(FAR struct uart_dev_s *dev, bool on)
{
  FAR struct stm32f0_serial_s *priv = (FAR struct stm32f0_serial_s *)dev->priv;
  uint32_t rcc_en;
  uint32_t regaddr;
...
static int stm32f0serial_setup(FAR struct uart_dev_s *dev)
{
   ...
   * was enabled in stm32f0_lowsetup().
   */

  /* Enable USART APB1/2 clock */

  stm32f0serial_setapbclock(dev, true);

  /* Configure pins for USART use */

  stm32f0_configgpio(priv->tx_gpio);
  stm32f0_configgpio(priv->rx_gpio);

#ifdef CONFIG_SERIAL_OFLOWCONTROL
  if (priv->cts_gpio != 0)
    {
      stm32f0_configgpio(priv->cts_gpio);
    }
#endif
  ...
  if (priv->rs485_dir_gpio != 0)
    {
      stm32f0_configgpio(priv->rs485_dir_gpio);
      stm32f0_gpiowrite(priv->rs485_dir_gpio, !priv->rs485_dir_polarity);
    }
#endif
...
static int stm32f0serial_dmasetup(FAR struct uart_dev_s *dev)
{
  ...
  if (!dev->isconsole)
    {
      result = stm32f0serial_setup(dev);
      if (result != OK)
        {
          return result;
        }
  ...
  priv->rxdma = stm32f0_dmachannel(priv->rxdma_channel);
  ...
  if (priv->iflow)
    {
      ...
      stm32f0_dmasetup(priv->rxdma,
                     priv->usartbase + STM32F0_USART_RDR_OFFSET,
  ...
  if (priv->iflow)
    {
      ...
      stm32f0_dmastart(priv->rxdma, stm32f0serial_dmarxcallback,
                       (void *)priv, false);
    }
  else
#endif
...
static void stm32f0serial_shutdown(FAR struct uart_dev_s *dev)
{
  ...
  stm32f0serial_disableusartint(priv, NULL);
  ...
  stm32f0_unconfiggpio(priv->tx_gpio);
  stm32f0_unconfiggpio(priv->rx_gpio);

#ifdef CONFIG_SERIAL_OFLOWCONTROL
  if (priv->cts_gpio != 0)
    {
      stm32f0_unconfiggpio(priv->cts_gpio);
    }
#endif
  ...
  if (priv->rts_gpio != 0)
    {
      stm32f0_unconfiggpio(priv->rts_gpio);
    }
#endif
  ...
  if (priv->rs485_dir_gpio != 0)
    {
      stm32f0_unconfiggpio(priv->rs485_dir_gpio);
    }
#endif
}

/****************************************************************************
 * Name: stm32f0serial_dmashutdown
 *
 * Description:
 *   Disable the USART.  This method is called when the serial
 *   port is closed
...
static void stm32f0serial_dmashutdown(FAR struct uart_dev_s *dev)
{
  ...
  stm32f0_dmastop(priv->rxdma);

  /* Release the DMA channel */

  stm32f0_dmafree(priv->rxdma);
  priv->rxdma = NULL;
}
#endif

/****************************************************************************
 * Name: stm32f0serial_attach
 *
 * Description:
...
static int up_interrupt(int irq, FAR void *context, FAR void *arg)
{
  FAR struct stm32f0_serial_s *priv = (FAR struct stm32f0_serial_s *)arg;
  int  passes;
  bool handled;
  ...
  for (passes = 0; passes < 256 && handled; passes++)
    {
      ...
      priv->sr = stm32f0serial_getreg(priv, STM32F0_USART_ISR_OFFSET);
      ...
      if ((priv->sr & USART_ISR_TC) != 0 && (priv->ie & USART_CR1_TCIE) != 0 &&
        ...
        {
          stm32f0_gpiowrite(priv->rs485_dir_gpio, !priv->rs485_dir_polarity);
          stm32f0serial_restoreusartint(priv, priv->ie & ~USART_CR1_TCIE);
        }
#endif
       ...
       */
      ...
      else if ((priv->sr & (USART_ISR_ORE | USART_ISR_NF | USART_ISR_FE)) != 0)
        {
          ...
          stm32f0serial_putreg(priv, STM32F0_USART_ICR_OFFSET,
                               ...
                               unsigned long arg)
{
  ...
  switch (cmd)
    ...
    case TIOCSERGSTRUCT:
      {
        FAR struct stm32f0_serial_s *user = (FAR struct stm32f0_serial_s *)arg;
        if (!user)
          {
            ret = -EINVAL;
          }
...
#ifdef CONFIG_STM32F0_USART_SINGLEWIRE
    ...
    case TIOCSSINGLEWIRE:
      {
        ...
        uint32_t cr = stm32f0serial_getreg(priv, STM32F0_USART_CR3_OFFSET);

        if (arg == SER_SINGLEWIRE_ENABLED)
          {
            stm32f0_configgpio(priv->tx_gpio | GPIO_OPENDRAIN);
            cr |= USART_CR3_HDSEL;
          }
        else
          {
            stm32f0_configgpio(priv->tx_gpio | GPIO_PUSHPULL);
            cr &= ~USART_CR3_HDSEL;
          }
...
#ifdef CONFIG_STM32F0_USART_BREAKS
#  ifdef CONFIG_STM32F0_SERIALBRK_BSDCOMPAT
    ...
    case TIOCSBRK:  /* No BSD compatibility: Turn break on for M bit times */
      {
        ...
        flags = enter_critical_section();
        cr1   = stm32f0serial_getreg(priv, STM32F0_USART_CR1_OFFSET);
        stm32f0serial_putreg(priv, STM32F0_USART_CR1_OFFSET, cr1 | USART_CR1_SBK);
        leave_critical_section(flags);
      }
      break;
                                 ...
                                 FAR unsigned int *status)
{
  ...
  rdr      = stm32f0serial_getreg(priv, STM32F0_USART_RDR_OFFSET);
...
static void stm32f0serial_rxint(FAR struct uart_dev_s *dev, bool enable)
{
  ...
  stm32f0serial_restoreusartint(priv, ie);
  leave_critical_section(flags);
}
#endif

/****************************************************************************
 * Name: stm32f0serial_rxavailable
 *
 * Description:
...
{
  FAR struct stm32f0_serial_s *priv = (FAR struct stm32f0_serial_s *)dev->priv;
  return ((stm32f0serial_getreg(priv, STM32F0_USART_ISR_OFFSET) & USART_ISR_RXNE) != 0);
}
#endif

/****************************************************************************
 * Name: stm32f0serial_rxflowcontrol
 *
 * Description:
                                        ...
                                        unsigned int nbuffered, bool upper)
{
  FAR struct stm32f0_serial_s *priv = (FAR struct stm32f0_serial_s *)dev->priv;
    ...
    defined(CONFIG_STM32F0_FLOWCONTROL_BROKEN)
  if (priv->iflow && (priv->rts_gpio != 0))
    {
      /* Assert/de-assert nRTS set it high resume/stop sending */

      stm32f0_gpiowrite(priv->rts_gpio, upper);
      return upper;
    }
                                    ...
                                    FAR unsigned int *status)
{
  ...
  if (stm32f0serial_dmanextrx(priv) != priv->rxdmanext)
    {
...
/****************************************************************************
 * Name: stm32f0serial_dmareenable
 *
 * Description:
...
static void stm32f0serial_dmareenable(FAR struct stm32f0_serial_s *priv)
{
  /* Configure for non-circular DMA reception into the RX fifo */
  ...
  stm32f0_dmastart(priv->rxdma, stm32f0serial_dmarxcallback, (FAR void *)priv,
                   false);
}
#endif

/****************************************************************************
 * Name: stm32f0serial_dmarxint
 *
 * Description:
 *   Call to enable or disable RX interrupts
 *
  ...
  if (priv->iflow && priv->rxenable && (priv->rxdmanext == RXDMA_BUFFER_SIZE))
    {
      ...
      stm32f0serial_dmareenable(priv);
    }
#endif
}
#endif
...
/****************************************************************************
 * Name: stm32f0serial_dmarxavailable
 *
 * Description:
 *   Return true if the receive register is not empty
 *
...
#ifdef SERIAL_HAVE_DMA
static bool stm32f0serial_dmarxavailable(FAR struct uart_dev_s *dev)
{
  FAR struct stm32f0_serial_s *priv = (FAR struct stm32f0_serial_s *)dev->priv;
  ...
  return (stm32f0serial_dmanextrx(priv) != priv->rxdmanext);
}
#endif

/****************************************************************************
 * Name: stm32f0serial_send
 *
 * Description:
...
static void stm32f0serial_send(FAR struct uart_dev_s *dev, int ch)
{
  ...
  stm32f0serial_putreg(priv, STM32F0_USART_TDR_OFFSET, (uint32_t)ch);
}

/****************************************************************************
 * Name: stm32f0serial_txint
 *
 * Description:
...
#  endif
  ...
  else
    {
      ...
      stm32f0serial_restoreusartint(priv, priv->ie & ~USART_CR1_TXEIE);
    }
...
{
  FAR struct stm32f0_serial_s *priv = (FAR struct stm32f0_serial_s *)dev->priv;
  return ((stm32f0serial_getreg(priv, STM32F0_USART_ISR_OFFSET) & USART_ISR_TXE) != 0);
}

/****************************************************************************
 * Name: stm32f0serial_dmarxcallback
 *
 * Description:
                                        ...
                                        FAR void *arg)
{
  ...
  if (priv->rxenable && stm32f0serial_dmarxavailable(&priv->dev))
    {
      uart_recvchars(&priv->dev);
...
#ifdef SERIAL_HAVE_DMA
void stm32f0serial_dmapoll(void)
{
    irqstate_t flags;
  ...
  if (g_usart1priv.rxdma != NULL)
    {
      stm32f0serial_dmarxcallback(g_usart1priv.rxdma, 0, &g_usart1priv);
    }
#endif
  ...
  if (g_usart2priv.rxdma != NULL)
    {
      stm32f0serial_dmarxcallback(g_usart2priv.rxdma, 0, &g_usart2priv);
    }
#endif
  ...
  if (g_usart3priv.rxdma != NULL)
    {
      stm32f0serial_dmarxcallback(g_usart3priv.rxdma, 0, &g_usart3priv);
    }
#endif
